...
import testex.JFfolder.FetcherFactory;
...
public class JokeFetcher {
    ...
    public Jokes getJokes(String jokesToFetch, String timeZone) throws JokeException {
        ...
        String tzString = DF.getFormattedDate(timeZone, new Date());
  ...
  public static void main(String[] args) throws JokeException {
    ...
    JokeFetcher jf = new JokeFetcher(new DateFormatter(), new FetcherFactory(new EduJoke(), new ChuckNorris(), new Moma(), new Tambal()));
